...
export const RESPONSE_AUTHENTICATION = 'RESPONSE_AUTHENTICATION';

export const START_SAVEAUTHENTICATION = 'START_SAVEAUTHENTICATION';
export const FINISH_SAVEAUTHENTICATION = 'FINISH_SAVEAUTHENTICATION';
