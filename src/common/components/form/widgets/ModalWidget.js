...
var WidgetMixin = require('react-native-gifted-form/mixins/WidgetMixin');

import {GiftedFormManager,GiftedFormModal} from 'react-native-gifted-form';
var TimerMixin = require('react-timer-mixin');

var moment = require('moment');

let disclosureIcon = require('react-native-gifted-form/icons/disclosure.png');
let closeIcon = require('react-native-gifted-form/icons/close.png');
let checkIcon = require('react-native-gifted-form/icons/check.png');
...
module.exports = React.createClass({
  ...
  propTypes: {
    ...
    onValueFormat: React.PropTypes.func
  },
      ...
      >
        <View style={this.getStyle('row')}>
          ...
          <View style={this.getStyle('alignRight')}>
            <Text numberOfLines={1} style={this.getStyle('modalValue')}>{this.props.onValueFormat(this.state.value)}</Text>
          </View>
